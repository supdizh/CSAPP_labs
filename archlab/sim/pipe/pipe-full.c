...
int gen_f_pc()
{
    return ((((ex_mem_curr->icode) == (I_JMP)) & !(ex_mem_curr->takebranch)
          ...
          (if_id_curr->icode) == (I_NOP))) ? (mem_wb_curr->valm) : ((
          (id_ex_curr->icode) == (I_PUSHL)) & ((if_id_curr->icode) == 
          (I_RET))) ? (id_ex_curr->vala) : (pc_curr->pc));
}
...
int gen_F_stall()
{
    return (((((id_ex_curr->icode) == (I_MRMOVL) || (id_ex_curr->icode) == 
            ...
            (ex_mem_curr->icode)) & ((I_PUSHL) != (mem_wb_curr->icode)))));
}
    ...
    return ((((id_ex_curr->icode) == (I_JMP)) & !(ex_mem_next->takebranch))
       | (!((((id_ex_curr->icode) == (I_MRMOVL) || (id_ex_curr->icode) == 
              ...
              (I_RET) == (if_id_curr->icode)) | (((I_RET) == 
                (id_ex_curr->icode)) & ((I_PUSHL) != (ex_mem_curr->icode)))
